# https://github.com/proroklab/popgym/blob/master/popgym/baselines/ppo.py
...
def main():
    ...
    env_names = ['popgym-LabyrinthEscapeEasy-v0']
    ...
    def trial_name(trial):
        ...
        return "-".join([str(s) for s in [model, emb, emb_size] if s is not None])
